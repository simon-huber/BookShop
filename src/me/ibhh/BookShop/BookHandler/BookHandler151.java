 ...
 * @author Simon
 */
public class BookHandler151 extends BookHandler {
...
// private ArrayList<String> pages;
    ...
    public BookHandler151(String title, String author, List<String> pages, int selled) throws InvalidBookException {
...
// this.pages = pages;
    ...
    public BookHandler151(ItemStack itemStack) throws InvalidBookException {
        this((CraftItemStack) itemStack);
    }

    public BookHandler151(CraftItemStack itemStack) throws InvalidBookException {
...
// this.pages = pages;
    ...
    public ItemStack toItemStack(int amount) throws InvalidBookException {
        net.minecraft.server.v1_5_R2.ItemStack nmsStack = CraftItemStack.asNMSCopy(new ItemStack(Material.WRITTEN_BOOK));
        nmsStack.setTag(tag);
//Zurück umwandeln
