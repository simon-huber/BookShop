 ...
 * @author Simon
 */
public class BookHandler132 extends BookHandler{
...
// private ArrayList<String> pages;
    ...
    public BookHandler132(String title, String author, List<String> pages, int selled) throws InvalidBookException {
...
// this.pages = pages;
    ...
    public BookHandler132(ItemStack itemStack) throws InvalidBookException {
        this((CraftItemStack) itemStack);
    }

    public BookHandler132(CraftItemStack itemStack) throws InvalidBookException {
